...
def play_one_move(col, row, valid_directions, turns, invalid_counter, valid_counter):
    ...
    return victory, col, row, turns, invalid_counter, valid_counter

def pull_leaver(total_coins, turns):
    if turns == 0: 
        pull_choice = random.choice([YES,NO])
        print('Pull a lever (y/n):', pull_choice)
...
def play():
    ...
    while not victory:
        ...
        victory, col, row, turns, invalid_counter, valid_counter = play_one_move(col, row, valid_directions, turns, invalid_counter, valid_counter)
    print("Victory! Total coins {}. Moves {}.".format(total_coins, (invalid_counter + valid_counter)))
